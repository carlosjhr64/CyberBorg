...
var Ai, BASE, CORDER_PASS, Command, CyberBorg, DERRICKS, DORDER_MAINTAIN, FACTORIES, FORDER_MANUFACTURE, Group, Groups, IS_LAIDOFF, LABS, LORDER_RESEARCH, SCOUTS, Scouter, Trace, WZArray, WZObject, ai, allowed_hqless_build, base_group, bug_report, cyberBorg, eventChat, eventDestroyed, eventDroidBuilt, eventDroidIdle, eventResearched, eventStartLevel, eventStructureBuilt, gotcha_idle, gotcha_rogue, gotcha_selected, gotcha_working, gotchas, script, start_trace, trace_command,
  __slice = [].slice;
